    ...
    return (
      <div>
        <form name="formComprador" method="get">
          ...
          <input data-testid={arr[0]} type="text" name="fullName" placeholder="Nome" onChange={this.atdad} />
          <input data-testid={arr[1]} type="number" name="CPF" placeholder="CPF" onChange={this.atdad} />
          <input data-testid={arr[2]} type="email" name="email" placeholder="email" onChange={this.atdad} />
          <input data-testid={arr[3]} type="number" name="telefone" placeholder="Tel" onChange={this.atdad} />
          <input data-testid={arr[4]} type="number" name="CEP" placeholder="CEP" onChange={this.atdad} />
          <input data-testid={arr[5]} type="text" name="endereco" placeholder="End." onChange={this.atdad} />
